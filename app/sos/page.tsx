...
export default function SOSPage() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-5 min-h-[85vh] flex flex-col justify-between">
      {/* Header */}
      ...
      <div className="my-auto py-6 space-y-6">
        {!isTriggered ? (
            ...
            {countdown !== null ? (
              <div className="p-8 bg-red-950 border-2 border-red-500 rounded-3xl text-center flex flex-col items-center animate-pulse">
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-slate-900 border border-slate-700 text-white font-bold rounded-xl text-sm hover:bg-slate-800 transition-colors"
                >
                  CANCEL ALARM ✕
                </button>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="text-center space-y-3">
                  <button
                    ...
                    disabled={submitting}
                    className="w-44 h-44 mx-auto rounded-full bg-gradient-to-tr from-red-600 to-rose-600 border-4 border-red-400/40 shadow-2xl shadow-red-950 flex flex-col items-center justify-center text-white active:scale-95 hover:scale-105 transition-transform"
                  >
                ...
                <div className="p-3 bg-slate-900 border border-slate-800 rounded-xl flex items-center gap-2 text-xs">
                ...
                <div className="p-4 bg-slate-900 border border-slate-800 rounded-2xl space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-xs text-white focus:border-red-500 outline-none"
                    />
                  </div>
          ...
          <div className="space-y-5 animate-in fade-in zoom-in-95">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-400">
                    Status: <span className="font-bold text-amber-400">{sosRecord?.status || 'PENDING'}</span>
                  </div>
                </div>
              </div>
            ...
            {/* Survival Guidance */}
            <div className="p-4 bg-slate-900 border border-slate-800 rounded-2xl space-y-2 text-xs text-slate-300">
      ...
      <div className="pt-3 border-t border-slate-800 text-center">
        <a
          href="tel:100"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-xs font-bold text-red-400 hover:text-red-300"
        >
